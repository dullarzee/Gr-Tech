  ...
  const faqs = [
    {
      ...
      answer:
        "Most solar panels last 25-30 years with minimal maintenance required.",
    },
    {
      question: "How long does installation take?",
      answer:
        "Standard residential installation typically takes 1-3 days depending on system size.",
    },
    {
      question: "Does solar energy reduce electricity bills?",
      answer:
        "Yes, solar energy can reduce your electricity bills by 50-90% depending on your system size.",
    },
    {
      question: "Will solar work during a power outage?",
      answer:
        "Without a battery backup system, solar panels do not work during outages for safety reasons.",
    },
    {
      question: "Do solar panels require maintenance?",
      answer:
        "Solar panels require minimal maintenance - occasional cleaning and annual inspections are recommended.",
    },
  ];
