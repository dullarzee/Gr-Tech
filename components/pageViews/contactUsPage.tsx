...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post(BEendpoints.send_mail, formData);
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full bg-amber-400 text-zinc-950 hover:bg-amber-300 font-semibold py-3 rounded-lg text-base"
                >
