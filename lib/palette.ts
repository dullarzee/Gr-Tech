export const themePalette = {
  dark: {
    backgroundPrimary: "from-zinc-950 via-zinc-900 to-zinc-950",
    text_light: "text-white",
    navlink_bg: "bg-gray-500/50",
    chip_style: "bg-zinc-800/50 border border-zinc-700/50 text-zinc-300",
  ...
  light: {
    ...
    text_dark: "text-slate-600",
    navlink_bg: "bg-gray-500/50",
    chip_style: "bg-zinc-100/50 border border-zinc-200/50 text-zinc-800",
